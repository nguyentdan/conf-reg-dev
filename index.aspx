   ...
   <script>
      window.ndApp = {
         ...
         env: {
            dev: {
               url: {
                  app: "http://sp2016",   // where the app is hosted
                  web: "http://sp2016"    // where sp lists reside
               },
               configFile: {
                  url: 'http://sp2016',
                  relative: 'SiteAssets/ES6/conf-reg',
                  name: 'config.txt'
               }
            },
            prod: {
               url: {
                  app: "https://ibamc.med.ds.osd.mil/SiteDirectory/Resources%20Management/app",
                  web: "https://ibamc.med.ds.osd.mil/SiteDirectory/Resources%20Management/cmb"
               },
               configFile: {
                  url: 'https://ibamc.med.ds.osd.mil/SiteDirectory/Resources%20Management/app',
                  relative: 'sites/test/SiteAssets/<folder>',
                  name: 'config.txt'
               }
            }
         }
